...
class CreatePriority < ActionController::IntegrationTest
  ...
  test "create a priority" do
    ...
    @browser.text_field(:name => "government[name]").set "foobar"
    @browser.text_field(:name => "government[description]").set "foobar"
    @browser.text_field(:name => "government[target]").set "foobar"
    @browser.text_field(:name => "government[domain_name]").set "localhost"
    @browser.text_field(:name => "government[admin_name]").set "foo"
    @browser.text_field(:name => "government[admin_email]").set "foo@bar.com"
